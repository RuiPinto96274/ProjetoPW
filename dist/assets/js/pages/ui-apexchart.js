...
//grafico de barras por atividade passei para dashboard.js
var barOptionsPorAtiv = {
	series: [
	  {
		name: "Bordado",
		data: [2,3,4,5,6,7,6,5,4,3,2,1],
	  },
	  {
		name: "Costura",
	...
	xaxis: {
	  categories: ["Jan","Fev","Mar","Abr","Mai","Jun","Jul", "Ag","Set","Out","Nov","Dez"],
	},
	yaxis: {
	  title: {
